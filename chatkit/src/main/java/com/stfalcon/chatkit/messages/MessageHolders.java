...
//    public static class CustomCustomIncomingActionMessageViewHolder<MESSAGE extends MessageContentType>
...
//
//        public CustomCustomIncomingActionMessageViewHolder(View itemView) {
//            super(itemView);
...
//            if(imageLoader != null) {
//            imageLoader.with(itemView.getContext()).load(imageUrl).into(actionImage);
